<?php namespace App\Http\Controllers;
	...
	class AdminNewsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Tanggal","name"=>"datetime_at"];
			$this->col[] = ["label"=>"Title","name"=>"title"];
			$this->col[] = ["label"=>"Img Thumbnail","name"=>"img_thumbnail"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Tanggal','name'=>'datetime_at','type'=>'date','validation'=>'required','width'=>'col-sm-9','placeholder'=>'Anda hanya dapat memasukkan huruf saja'];
			$this->form[] = ['label'=>'Title','name'=>'title','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Img Thumbnail','name'=>'img_thumbnail','type'=>'upload','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Content','name'=>'content','type'=>'wysiwyg','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Active','name'=>'active','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Img Thumbnail","name"=>"img_thumbnail","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
